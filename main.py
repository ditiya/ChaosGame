...
class Main:
    ...
    def gen_bg_pixels(self):
        ...
        iska use background ko pixel by pixel fill karne ke liye kiye hai, isse accha colour effect aaega
        """
    ...
    def generate_point(self):  # Create the next point
        """
         ye fumction native point list ko utilise karta hai , jisse ek random point leta hai
         fir half distance pe point banata hai fir yahi process repeat karta hai"""
